...
PORTLAND_FOLDER_PATH = os.path.abspath("/Users/mirek/workspace/rynly/zipcode-kml/subset/portland")
SEATTLE_FOLDER_PATH = os.path.abspath("/Users/mirek/workspace/rynly/zipcode-kml/subset/seattle")
